...
public class NumoccurFeatGen extends AbstractFeatureGenerator implements
	...
	private static void addGlobalFeatures(List<String> features, 
			numoccur.NumoccurX x, numoccur.NumoccurY y) {
	...
	private static void addOneOrTwoFeatures(List<String> features, 
			numoccur.NumoccurX x, numoccur.NumoccurY y) {
	...
	private static void addQuantPhraseFeatures(List<String> features, 
			numoccur.NumoccurX x, numoccur.NumoccurY y) {
		QuantSpan qs = x.quantities.get(x.quantIndex);
		String quantPhrase = x.ta.getText().substring(qs.start, qs.end);
	...
	private static void addUnitfeatures(List<String> features, 
			numoccur.NumoccurX x, numoccur.NumoccurY y) {
	...
	private static void addLexfeatures(List<String> features, 
			numoccur.NumoccurX x, numoccur.NumoccurY y) {
	...
	private static void addPOSfeatures(List<String> features, 
			numoccur.NumoccurX x, numoccur.NumoccurY y) {
	...
	private static void addFeature(String string,
			numoccur.NumoccurY y, List<String> features) {
