...
//		System.out.println("Feature already extracted");
	...
	public IFeatureVector getExpressionFeatureVector(LcaX x, Node node) {
		List<String> features = expressionFeatures(x, node);
		return FeatGen.getFeatureVectorFromList(features, lm);
	}

	public IFeatureVector getVarTokenFeatureVector(LcaX x, LcaY y) {
	...
	public static List<String> expressionFeatures(LcaX x, Node node) {
		List<String> features = new ArrayList<>();
	...
	public static List<String> varTokenFeatures(LcaX x, LcaY y) {
		List<String> features = new ArrayList<>();
		List<String> unigrams = FeatGen.getUnigrams(x.ta);
