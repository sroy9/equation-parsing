...
public class LcaFeatGen extends AbstractFeatureGenerator implements
	...
	private static void addGlobalFeatures(List<String> features, LcaX x, LcaY y) {
		if(x.quantities.size() == 1) {
			addFeature("OneQuantityPresent", y, features);
		}
	}

	private static void addOneOrTwoFeatures(List<String> features, LcaX x, LcaY y) {
	...
	private static void addQuantPhraseFeatures(List<String> features, LcaX x, LcaY y) {
		QuantSpan qs = x.quantities.get(x.quantIndex);
		String quantPhrase = x.ta.getText().substring(qs.start, qs.end);
	...
	private static void addUnitfeatures(List<String> features, LcaX x, LcaY y) {
	...
	private static void addLexfeatures(List<String> features, LcaX x, LcaY y) {
	...
	private static void addPOSfeatures(List<String> features, LcaX x, LcaY y) {
