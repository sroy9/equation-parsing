...
//		System.out.println("Feature already extracted");
	...
	public IFeatureVector getExpressionFeatureVector(VarX x, Node node) {
		List<String> features = expressionFeatures(x, node);
		return FeatGen.getFeatureVectorFromList(features, lm);
	}

	public IFeatureVector getVarTokenFeatureVector(VarX x, VarY y) {
	...
	public static List<String> expressionFeatures(VarX x, Node node) {
		List<String> features = new ArrayList<>();
	...
	public static List<String> varTokenFeatures(VarX x, VarY y) {
		List<String> features = new ArrayList<>();
		List<String> unigrams = FeatGen.getUnigrams(x.ta);
