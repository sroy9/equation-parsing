...
public class CompY extends Equation implements IStructure, Serializable {
	...
	public static float getLoss(CompY y1, CompY y2) {
		float loss1 = CompY.getLossOrderFixed(y1, y2);
		// copy made to compute the alternate loss
		CompY y11 = new CompY(y1);
		exchange(y11.terms);
		exchange(y11.operations);
		float loss2 = CompY.getLossOrderFixed(y11, y2);
	...
	public static float getLossOrderFixed(CompY y1, CompY y2) {
		float loss = 0.0f;
