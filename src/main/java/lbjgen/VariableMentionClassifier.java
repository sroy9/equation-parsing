...
// 
...
public class VariableMentionClassifier extends SparseNetworkLearner
{
  ...
  static
  {
    _lcFilePath = VariableMentionClassifier.class.getResource("VariableMentionClassifier.lc");

    if (_lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate VariableMentionClassifier.lc in the class path.");
      System.exit(1);
    }

    _lexFilePath = VariableMentionClassifier.class.getResource("VariableMentionClassifier.lex");

    if (_lexFilePath == null)
    {
      System.err.println("ERROR: Can't locate VariableMentionClassifier.lex in the class path.");
      System.exit(1);
    }
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (VariableMentionClassifier) Learner.readLearner(_lcFilePath);
      instance.readLexiconOnDemand(_lexFilePath);
    }
  }

  public static Parser getParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/Users/Shyam/projects_1/equation/src/main/java/lbjgen/VariableMentionClassifier.ex"); }
  public static Parser getTestParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/Users/Shyam/projects_1/equation/src/main/java/lbjgen/VariableMentionClassifier.test.ex"); }
  public static boolean isTraining;
  public static VariableMentionClassifier instance;

  public static VariableMentionClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private VariableMentionClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "lbjgen";
    name = "VariableMentionClassifier";
    setEncoding(null);
    setLabeler(new VariableMentionLabel());
    setExtractor(new VariableMentionFeatures());
    isClone = false;
  }
  ...
  public VariableMentionClassifier()
  {
    super("lbjgen.VariableMentionClassifier");
    isClone = true;
  }

	public VariableMentionClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public VariableMentionClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(VariableMentionClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(VariableMentionClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(VariableMentionClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "lbjgen";
			name = "VariableMentionClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Mention || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'VariableMentionClassifier(Mention)' defined on line 17 of VariableMentionClassifier.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof Mention[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof Mention || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjgen.VariableMentionClassifier \\");
    ...
    VariableMentionClassifier classifier = new VariableMentionClassifier();
  ...
  public int hashCode() { return "VariableMentionClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof VariableMentionClassifier; }
