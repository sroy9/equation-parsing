...
public class OperationClassifier extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new OperationClassifier(true);
  }

  public static Parser getParser() { return new OperationParser(0.0, 0.8); }
  public static Parser getTestParser() { return new OperationParser(0.8, 1.0); }

  public static boolean isTraining;
  public static OperationClassifier instance;

  public static OperationClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private OperationClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "lbjgen";
    name = "OperationClassifier";
    setEncoding(null);
    setLabeler(new OperationLabel());
    setExtractor(new OperationFeatures());
    isClone = false;
  }
  ...
  public OperationClassifier()
  {
    super("lbjgen.OperationClassifier");
    isClone = true;
  }

	public OperationClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public OperationClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(OperationClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(OperationClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(OperationClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "lbjgen";
			name = "OperationClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Expression || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'OperationClassifier(Expression)' defined on line 17 of OperationClassifier.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjgen.OperationClassifier \\");
    ...
    OperationClassifier classifier = new OperationClassifier();
  ...
  public int hashCode() { return "OperationClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof OperationClassifier; }
