...
public class CompleteClassifier extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new CompleteClassifier(true);
  }

  public static Parser getParser() { return new CompleteParser(0.0, 0.8); }
  public static Parser getTestParser() { return new CompleteParser(0.8, 1.0); }

  public static boolean isTraining;
  public static CompleteClassifier instance;

  public static CompleteClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private CompleteClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "lbjgen";
    name = "CompleteClassifier";
    setEncoding(null);
    setLabeler(new CompleteLabel());
    setExtractor(new CompleteFeatures());
    isClone = false;
  }
  ...
  public CompleteClassifier()
  {
    super("lbjgen.CompleteClassifier");
    isClone = true;
  }

	public CompleteClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public CompleteClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(CompleteClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(CompleteClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(CompleteClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "lbjgen";
			name = "CompleteClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Expression || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'CompleteClassifier(Expression)' defined on line 17 of CompleteClassifier.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof Expression[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof Expression || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjgen.CompleteClassifier \\");
    ...
    CompleteClassifier classifier = new CompleteClassifier();
  ...
  public int hashCode() { return "CompleteClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof CompleteClassifier; }
